...
REACTION_EFFECTS: dict = {
    ...
    "\u2764": _eff("positive", {"love": 0.08, "blush": 0.05}, "love"),            # ❤
    "\U0001f970": _eff("positive", {"love": 0.08, "blush": 0.05, "happy": 0.03}, "love"),  # 🥰
    "\U0001f60d": _eff("positive", {"love": 0.09, "blush": 0.05}, "love"),        # 😍
    "\u2764\u200d\U0001f525": _eff("positive", {"love": 0.09, "blush": 0.06, "teasing": 0.03}, "love"),  # ❤‍🔥
    "\U0001f48b": _eff("positive", {"love": 0.07, "blush": 0.07, "teasing": 0.03}, "love"),  # 💋
    "\U0001f498": _eff("positive", {"love": 0.08, "blush": 0.05}, "love"),        # 💘
    "\U0001f618": _eff("positive", {"love": 0.07, "blush": 0.05}, "love"),        # 😘
    "\U0001f917": _eff("positive", {"love": 0.05, "happy": 0.04}),                # 🤗

    # --- Радость / смех / праздник (positive, happy) ---
    "\U0001f601": _eff("positive", {"happy": 0.07}),                              # 😁
    "\U0001f923": _eff("positive", {"happy": 0.07, "teasing": 0.04}),             # 🤣
    "\U0001f389": _eff("positive", {"happy": 0.07}),                              # 🎉
    "\U0001f37e": _eff("positive", {"happy": 0.06}),                              # 🍾
    "\U0001f44f": _eff("positive", {"happy": 0.05}),                              # 👏
    "\U0001f4af": _eff("positive", {"happy": 0.05, "teasing": 0.02}),             # 💯
    "\U0001f3c6": _eff("positive", {"happy": 0.05}),                              # 🏆
    "\U0001f192": _eff("positive", {"happy": 0.04, "teasing": 0.02}),             # 🆒
    "\U0001f60e": _eff("positive", {"happy": 0.04, "teasing": 0.03}),             # 😎

    # --- Азарт / огонь (сильные → reply "teasing") ---
    "\U0001f525": _eff("positive", {"teasing": 0.08, "happy": 0.04}, "teasing"),  # 🔥
    "\u26a1": _eff("positive", {"teasing": 0.05, "happy": 0.03}),                 # ⚡
    "\U0001f608": _eff("positive", {"teasing": 0.08, "love": 0.03}, "teasing"),   # 😈

    # --- Восхищение / шок (сильные → reply) ---
    "\U0001f929": _eff("positive", {"happy": 0.07, "shock": 0.04, "love": 0.03}, "happy"),  # 🤩
    "\U0001f92f": _eff("positive", {"shock": 0.08, "happy": 0.04}, "happy"),      # 🤯
    "\U0001f631": _eff(None, {"shock": 0.08}, "shock"),                           # 😱
    "\U0001f433": _eff("positive", {"shock": 0.05, "happy": 0.03}),               # 🐳
    "\U0001f984": _eff("positive", {"happy": 0.05, "teasing": 0.03}),             # 🦄

    # --- Одобрение / согласие (мягкий positive) ---
    "\U0001f44d": _eff("positive", {"happy": 0.04}),                              # 👍
    "\U0001f44c": _eff("positive", {"happy": 0.04}),                              # 👌
    "\U0001f91d": _eff("positive", {"happy": 0.04}),                              # 🤝
    "\U0001fae1": _eff("positive", {"happy": 0.03, "teasing": 0.02}),             # 🫡
    "\U0001f64f": _eff("positive", {"love": 0.03, "happy": 0.03}),                # 🙏
    "\u270d": _eff(None, {"thinking": 0.04}),                                     # ✍
    "\U0001f607": _eff("positive", {"happy": 0.04, "love": 0.02}),                # 😇
    "\U0001f54a": _eff("positive", {"happy": 0.03}),                              # 🕊

    # --- Раздумье / любопытство / скепсис (нейтрально, thinking) ---
    "\U0001f914": _eff(None, {"thinking": 0.06}),                                 # 🤔
    "\U0001f928": _eff(None, {"thinking": 0.05, "bored": 0.02}),                  # 🤨
    "\U0001f913": _eff(None, {"thinking": 0.05}),                                 # 🤓
    "\U0001f468\u200d\U0001f4bb": _eff(None, {"thinking": 0.05}),                 # 👨‍💻
    "\U0001f440": _eff(None, {"thinking": 0.05, "teasing": 0.02}),                # 👀

    # --- Игривое / дурашливое / троллинг (teasing) ---
    "\U0001f92a": _eff("positive", {"teasing": 0.07, "happy": 0.04}),             # 🤪
    "\U0001f31a": _eff(None, {"teasing": 0.05}),                                  # 🌚
    "\U0001f648": _eff("positive", {"blush": 0.05, "teasing": 0.03}),             # 🙈
    "\U0001f649": _eff(None, {"teasing": 0.04}),                                  # 🙉
    "\U0001f64a": _eff(None, {"teasing": 0.04, "blush": 0.03}),                   # 🙊
    "\U0001f47b": _eff(None, {"teasing": 0.04}),                                  # 👻
    "\U0001f383": _eff(None, {"teasing": 0.03}),                                  # 🎃
    "\U0001f47e": _eff(None, {"teasing": 0.03, "happy": 0.02}),                   # 👾
    "\U0001f5ff": _eff(None, {"bored": 0.04, "teasing": 0.02}),                   # 🗿
    "\U0001f485": _eff(None, {"teasing": 0.05}),                                  # 💅
    "\U0001f974": _eff(None, {"teasing": 0.04, "shock": 0.02}),                   # 🥴
    "\U0001f34c": _eff(None, {"teasing": 0.03}),                                  # 🍌
    "\U0001f32d": _eff(None, {"teasing": 0.03}),                                  # 🌭
    "\U0001f353": _eff(None, {"teasing": 0.03}),                                  # 🍓
    "\U0001f48a": _eff(None, {"teasing": 0.02}),                                  # 💊
    "\U0001f921": _eff("negative", {"teasing": 0.04, "angry": 0.03}),             # 🤡

    # --- Скука / отмашка (мягкий negative, bored) ---
    "\U0001f971": _eff("negative", {"bored": 0.07}),                              # 🥱
    "\U0001f634": _eff("negative", {"bored": 0.07}),                              # 😴
    "\U0001f610": _eff("negative", {"bored": 0.05}),                              # 😐
    "\U0001f937": _eff(None, {"bored": 0.04, "thinking": 0.02}),                  # 🤷
    "\U0001f937\u200d\u2642": _eff(None, {"bored": 0.04, "thinking": 0.02}),      # 🤷‍♂
    "\U0001f937\u200d\u2640": _eff(None, {"bored": 0.04, "thinking": 0.02}),      # 🤷‍♀

    # --- Грусть / боль (эмоционально; сильные → reply "tender") ---
    "\U0001f494": _eff("negative", {"sad": 0.09}, "tender"),                      # 💔
    "\U0001f62d": _eff(None, {"sad": 0.07}, "tender"),                            # 😭
    "\U0001f622": _eff("negative", {"sad": 0.07}, "tender"),                      # 😢
    "\U0001f628": _eff(None, {"shock": 0.05, "sad": 0.04}),                       # 😨

    # --- Враждебное / негатив (negative, angry; без авто-ответа) ---
    "\U0001f44e": _eff("negative", {"angry": 0.05, "sad": 0.03}),                 # 👎
    "\U0001f4a9": _eff("negative", {"angry": 0.04}),                              # 💩
    "\U0001f92c": _eff("negative", {"angry": 0.09}),                              # 🤬
    "\U0001f621": _eff("negative", {"angry": 0.08}),                              # 😡
    "\U0001f92e": _eff("negative", {"angry": 0.05}),                              # 🤮
    "\U0001f595": _eff("negative", {"angry": 0.09}),                              # 🖕

    # --- Сезонное / нейтральное (лёгкий тёплый оттенок) ---
    "\U0001f385": _eff(None, {"happy": 0.02}),                                    # 🎅
    "\U0001f384": _eff(None, {"happy": 0.02}),                                    # 🎄
    "\u2603": _eff(None, {"happy": 0.02}),                                        # ☃
}
